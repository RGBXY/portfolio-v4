  ...
  return (
    <div className="w-full h-full pt-20 flex items-center justify-center text-center">
      <div className="space-y-8 flex flex-col items-center w-full">
        ...
        <p className="max-w-sm mx-auto w-full">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Nulla atque nobis eveniet et.</p>

        <div className="mt-10 w-full flex items-center justify-center">
          <div className="h-70 w-87.5 border border-black rounded-xl -rotate-4 bg-gray-300 z-5 hover:-rotate-8 hover:scale-110 transition"></div>
          <div className="h-70 w-87.5 border border-black rounded-xl rotate-4 translate-y-6 -ml-10 bg-gray-300 z-4 hover:rotate-8 hover:scale-110 transition"></div>
          <div className="h-70 w-87.5 border border-black rounded-xl -ml-10 -rotate-4 bg-gray-300 z-3 hover:-rotate-8 hover:scale-110 transition"></div>
          <div className="h-70 w-87.5 border border-black rounded-xl -ml-10 rotate-4 translate-y-6 bg-gray-300 hover:rotate-8 hover:scale-110 transition"></div>
        </div>
      </div>
    </div>
  );
